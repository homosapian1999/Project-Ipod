...
// Importing the case of the Ipod;
import Case from "./Case";

// Import Songs:
import song1 from "../static/songs/As It Was- Harry Styles.mp3";
import song2 from "../static/songs/Best is Yet to Come- Gryffin.mp3";
import song3 from "../static/songs/Dandelions-Ruth B.mp3";
import song4 from "../static/songs/Running up that Hill- Kate Bush.mp3";
import song5 from "../static/songs/Under the Influence- Chris Brown.mp3";

// Importing thumbnails;
import song1Img from "../static/As It Was- Harry Styles - Image.jpg";
import song2Img from "../static/Best is Yet to Come - Image.jpg";
import song3Img from "../static/Dandelions-Image.jpg";
import song4Img from "../static/Running Up That Hill -Kate Bush.png";
import song5Img from "../static/Under the Influence - Image.jpg";

// Importing wallpapers;
import boat from "../static/boat.jpg";
import moon from "../static/moon.jpg";
import purplePetal from "../static/purplePetal.jpg";
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      wallpaperItems: [boat, moon, purplePetal], //wallpapers
      songItems: ["As It Was- Harry Styles", "Best is Yet to Come- Gryffin", "Dandelions-Ruth B", "Running up that Hill- Kate Bush", "Under the Influence- Chris Brown"], //song names
      songIndex: 0, //current song
      lengthMenuKey: { "-1": 3, 1: 2, 4: 4, 8: 4, 3: 2, 9: 3 ,10:2},  //length of a particular menu, so for Eg: -1 which is lockscreen has 4 items (0 based indexing);
